    ...
    if (detailStats) {
        ...
        detailStats.innerHTML = `
            <div class="stats-grid">
                ...
                <div class="stats-item"><span class="stats-icon">💧</span><span class="stats-value">${stats.helpWater || 0}</span><span class="stats-label">浇水</span></div>
                <div class="stats-item"><span class="stats-icon">🌿</span><span class="stats-value">${stats.helpWeed || 0}</span><span class="stats-label">除草</span></div>
                <div class="stats-item"><span class="stats-icon">🐛</span><span class="stats-value">${stats.helpPest || 0}</span><span class="stats-label">除虫</span></div>
            </div>
        `;
    }
...
function appendLog(accountId, level, message, timestamp) {
    ...
    // 智能自动滚动：只在用户已经在底部时才滚动
    const isNearBottom = logsDiv.scrollHeight - logsDiv.scrollTop - logsDiv.clientHeight < 100;
    if (window.autoScrollLogs && isNearBottom) {
